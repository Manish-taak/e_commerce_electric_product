...
const Countraydrop = (props) => {
  ...
  return (
    <>
      <div style={{ right: '26%', top:"80%" }} className={props.country ? "dropdownalltypes active" : "dropdownalltypes"}>
          <div className='droppdown-language-inputs' >
              ...
              listlanguage.map((item, index) => {
                return (
                  <Fragment key={Date.now() + index} >
                    <li style={{ color: "#495f6a" }} className=' common-16-1 languages-option  ' >{item.name}
                      <svg className='rigth-icon-list' xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
