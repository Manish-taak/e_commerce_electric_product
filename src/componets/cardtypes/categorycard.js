                        ...
                        <Fragment key={index} >
                            <div className="category-cards cardcategory ">
                                ...
                                <div className="category-cards-images">
                                    <img style={{borderRadius:"10px 0 0 0"}} src={require(`../img/${item['img1']}`)} alt="r1" />
                                    <img style={{borderRadius:"0 10px 0 0"}} src={require(`../img/${item['img2']}`)} alt="rr" />
                                    <img style={{borderRadius:"0 0 0 10px"}} src={require(`../img/${item['img3']}`)} alt="r3" />
                                    <img style={{borderRadius:"0 0 10px 0"}} src={require(`../img/${item['img4']}`)} alt="r4" />
                                </div>
